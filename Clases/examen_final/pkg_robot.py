...
def define_robot(objetos):
    clear()
    print('-----------------------------------------------------------------------------------')
    print('-                               Examen INTER 2024-1                               -')
    print('-----------------------------------------------------------------------------------')

    print('Escriba una letra para la representación del robot, por ejemplo: S')
    objetos['robot'] = input('Robot: ')

    print('Escriba una letra para la representación del camino, por ejemplo: .')
    objetos['camino'] = input('Camino: ')

    print('Escriba una letra para la representación del obstaculo, por ejemplo: #')
    objetos['obstaculo'] = input('Obstaculo: ')

    print('Escriba una letra para la representación del destino, por ejemplo: E')
    objetos['destino'] = input('Destino: ')
...
def define_mapa(objetos):
    # Esta es la forma vieja para la creacion del mapa
    mapa = [
        ['#', '#', '#', '#', '#', '#', '#', '#', '#', '#'],
        ['#', 'S', '.', '.', '.', '.', '.', '.', '.', '#'],
        ['#', '.', '#', '.', '#', '#', '#', '#', '.', '#'],
    ...
    # Defina la nueva forma de crear el mapa de forma dinamica baseada en el objeto 'objetos'
    # mapa = None
...
def main():
    ...
    dict_objetos = define_robot({})
    mapa = define_mapa(dict_objetos)
