class Posicion:
        ...
        def __str__(self):
            return 'Posición ({0}, {1})'.format(self.x, self.y)
...
class Carro:
    ...
    def conducir(self, direccion):
        if self.gasolina > 0 and self.prendido:
            ...
            print('Conduce hacia {0}'.format(direccion))
            ...
            print('Quedan {0} litros'.format(self.gasolina))
    ...
    def __str__(self):
        return 'Carro en {0}'.format(self.posicion)
